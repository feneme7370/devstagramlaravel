    ...
    <body class="bg-gray-100">
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between items-center">
                <a href="{{ route('home') }}" class="font-black text-3xl">DevStagram</a>
                ...
                {{-- mostrar solo si esta autenticado --}}
                @auth
                    <nav class="flex gap-2 items-center">
                        ...
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button class="font-bold uppercase text-gray-600 text-sm" href="{{route('logout')}}" type="submit">
                                Cerrar sesion
                            </button>
                        </form>
                    </nav>
                ...
                {{-- mostrar solo si no esta autenticado --}}
                @guest
                    <nav class="flex gap-2 items-center">
        ...
        <main class="mt-10 mx-auto container px-5">
